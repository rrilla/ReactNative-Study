...
// prettier-ignore
import {StyleSheet, View, Text, Switch, TextInput, Keyboard, KeyboardAvoidingView, findNodeHandle, TextInputFocusEventData, NativeSyntheticEvent} from 'react-native'
